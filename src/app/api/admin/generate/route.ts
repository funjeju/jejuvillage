...
아래 JSON 스키마로만 응답(JSON 외 텍스트 금지):
{
  ...
  "stories": [
    ...
    {"sectionKey":"legend","title":"짧은 제목(10자 이내)","body":"설화·전설을 흥미롭게 서술한 2~3문장. 뚜렷한 설화가 없으면 마을 이름의 유래나 이곳만의 분위기·정취를 이야기하듯 서술(반드시 채울 것, 비우지 말 것)."},
...
중요: stories 배열은 반드시 history, legend, resource 3개를 모두 채워서 반환한다. 어느 하나도 비우거나 생략하지 말 것.`,
        },
      ],
    }),
  });
